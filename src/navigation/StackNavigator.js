    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          name="SchemePointDetails"
          component={SchemePointDetails}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        <Stack.Screen
          ...
          name="CheckKycOptions"
          component={CheckKycOptions}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        <Stack.Screen
          ...
          name="TargetAchievementDetails"
          component={TargetAchievementDetails}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        ></Stack.Screen>
          ...
          name="VerifyOtpForMpin"
          component={VerifyOtpForMpin}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
...
<Stack.Screen
          ...
          name="MpinValidationScreen"
          component={MpinValidationScreen}
        ></Stack.Screen>
