...
const App = () => {
  ...
  console.log("Version check",JSON.stringify(VersionCheck.getPlayStoreUrl({ packageName: 'com.genefied.dixcyScott' })))
    useEffect(() => {
      ...
      useEffect(() => {
        const checkAppVersion = async () => {
          try {
    const latestVersion = Platform.OS === 'ios'? await fetch(`https://itunes.apple.com/in/lookup?bundleId=com.genefied.dixcyScott`)
                    .then(r => r.json())
                ...
                [
                  {
                    ...
                    onPress: () => {
                      Linking.openURL(
                        Platform.OS === 'ios'
                          ? 'https://apps.apple.com/in/app/dixcy scott-%E0%A4%8F%E0%A4%95-%E0%A4%AA%E0%A4%B9%E0%A4%B2-%E0%A4%85%E0%A4%AA%E0%A4%A8-%E0%A4%95-%E0%A4%B8-%E0%A4%A5/id1554075490'
